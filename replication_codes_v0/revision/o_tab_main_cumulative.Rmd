...
mean_delay=reg_df_subset[!is.na(wins_pc_cumulative_delay) 
                  & action_date_year_quarter<=as.Date('2012-06-30'), 
              .(avg_delay=mean(wins_pc_cumulative_delay),
                se_delay=sd(wins_pc_cumulative_delay,na.rm=T)/sqrt(.N)
                ),  
...
m1=feols(wins_pc_cumulative_delay~treat_new+
                            post_t:treat_new+
...
m2=feols(wins_pc_cumulative_delay~treat_new+
                            post_t:treat_new+
                            log(wins_project_quarter_stage)+
                            log(1+winsorized_initial_duration_in_days_i)+
                            log(1+winsorized_initial_budget_i)+
...
m3=feols(wins_pc_cumulative_delay~treat_new+
                            post_t:treat_new+
                            log(wins_project_quarter_stage)+
                            log(1+winsorized_initial_duration_in_days_i)+
                            log(1+winsorized_initial_budget_i)+
