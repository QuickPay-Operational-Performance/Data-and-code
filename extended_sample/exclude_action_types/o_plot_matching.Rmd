...
reg_df=setDT(reg_df)
reg_df_subset=reg_df[!is.na(treat_new) &
...
matched_df_1=match.data(matchit(treat_new~as.factor(awarding_sub_agency_code)+
                                  ...
                                  wins_offers,
                                data=input,
                                cutpoints= list(wins_initial_duration = 5,
                                                wins_initial_budget = 5,
                                                wins_offers=5),
                                method='cem'))

matched_df_2=match.data(matchit(treat_new~as.factor(two_digit_psc)+
                               as.factor(two_digit_naics)+
                                as.factor(action_date_year_quarter)+
                                  wins_initial_duration+
                                  wins_initial_budget+
...
matched_df_3=match.data(matchit(treat_new~wins_initial_duration+
                                  wins_initial_budget+
                                  wins_offers,
                      data=input,
                      exact=~ as.factor(two_digit_psc)+
                               as.factor(two_digit_naics)+
                                as.factor(action_date_year_quarter),
                      method='nearest',verbose=T,
                      ratio=1))

matched_df_4=match.data(matchit(treat_new~wins_initial_duration+
                                  wins_initial_budget+
                                  wins_offers,
                      data=input,
                      exact=~as.factor(two_digit_psc)+
...
matched_df_5=match.data(matchit(treat_new~wins_initial_duration+
                                  wins_initial_budget+
                                  wins_offers,
                      data=input,
                      exact=~as.factor(two_digit_psc)+
...
matched_df_6=match.data(matchit(treat_new~wins_initial_duration+
                                  wins_initial_budget+
                                  wins_offers,
                      data=input,
                      exact=~as.factor(two_digit_psc)+
...
matched_df_7=match.data(matchit(treat_new~wins_initial_duration+
                                  wins_initial_budget+
                                  wins_offers,
                      data=input,
                      exact=~as.factor(two_digit_psc)+
...
matched_df_8=match.data(matchit(treat_new~wins_initial_duration+
                                  wins_initial_budget+
                                  wins_offers,
                      data=input,
                      exact=~as.factor(two_digit_psc)+
...
matched_df_9=match.data(matchit(treat_new~wins_initial_duration+
                                  wins_initial_budget+
                                  wins_offers,
                      data=input,
...
matched_df_10=match.data(matchit(treat_new~wins_initial_duration+
                                  wins_initial_budget+
                                  wins_offers,
                      data=input,
                      exact=~as.factor(awarding_sub_agency_code)+
...
matched_df_11=match.data(matchit(treat_new~wins_initial_duration+
                                  wins_initial_budget+
                                  wins_offers+
...
for(df in df_list){
  ...
  m=feols(wins_percentage_delay~treat_new+
                            ...
                            wins_offers+
                            post_t:log(1+wins_initial_duration)+
                            post_t:log(1+wins_initial_budget)+
                            post_t:wins_offers|
...
models=setDT(models)
models[,specification:=as.factor(seq(1,length(order)))]
...
b=ggplot(models, aes(x=specification,
  ...
  theme(axis.text.x = element_blank(),
        ...
        axis.line = element_blank(),
        panel.background = element_rect(color="black"))+
  scale_y_continuous(label=comma,limits=c(0,320000))+
  ylab("Sample size")+
  xlab("")
...
models2[,method_name:=case_when(method=="quick"~"Full matching",
                                ...
                                method=="Subclassification"~"Subclassification")]
...
ggsave(paste0(getwd(),
              "/alt_matching_qp_extended_sample.png"),
...
setFixest_dict(dict=c("treat_new" = "Treat",
               "post_t"="Post",
               "log(1+wins_initial_duration)"="Initial duration",
               "log(1+wins_initial_budget)"="Initial budget",
               "wins_offers"="Number of offers received",
