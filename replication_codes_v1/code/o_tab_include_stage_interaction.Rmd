...
etable(delay_rates,
       ...
       digits.stats = 2,
       fontsize = "tiny",
       caption="DiD with and without stage interaction",
       headers=list(" "=list("Excluding Stage $\\times Post_t$"=as.numeric(length(delay_rates)),
                    "Including Stage $\\times Post_t$"=as.numeric(length(stage_post)),
                    "Excluding X $\\times Post_t$"=as.numeric(length(no_post_interaction)))),
       fitstat = c("pr2","n","r2"),
