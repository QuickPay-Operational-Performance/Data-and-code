...
$DelayDays_{it}=\beta_0 + \beta_1 Treat_i + \beta_2 (Treat_i \times Quarter_t) + Stage_{it} + Controls_{it} + \gamma_{t} + \theta_{i}+\epsilon_{it}$
...
mod_twfe = fixest::feols(winsorized_delay ~ i(time_to_treat, treat_new, ref = -1) +
                    	   	#  treat_new+
