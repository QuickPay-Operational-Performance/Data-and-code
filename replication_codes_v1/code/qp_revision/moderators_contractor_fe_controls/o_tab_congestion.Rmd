...
```{r num_projects_0,warning=FALSE, echo=FALSE, results='asis', message=FALSE}
...
```{r budget_0,warning=FALSE, echo=FALSE, results='asis', message=FALSE}
## Budget
...
```{r tasks_0,warning=FALSE, echo=FALSE, results='asis', message=FALSE}
## Number of tasks
