...
subfolders <- subfolders[
  grepl("FY(2008|2009|2010|2011|2012)_097_Contracts_Full_20200205", subfolders)
]
...
```{r}
start_end_dates=start_end_dates[end_quarter>=as.Date('2007-12-31')&
                                  start_quarter>=as.Date('2007-12-31')]
```

```{r}
start_end_dates[, start_quarter:=case_when(start_quarter<as.Date('2007-12-31')~
                                             as.Date('2007-12-31'),
...
start_end_dates[, end_quarter:=case_when(end_quarter<as.Date('2007-12-31')~
                                             as.Date('2007-12-31'),
                                         end_quarter>as.Date('2012-12-31')~
                                           as.Date('2012-12-31'),
                                         end_quarter>=as.Date('2007-12-31') &
...
```{r export_file, include=FALSE}
 saveRDS(reg_df, 
         file = "/Users/vibhutid_admin/Desktop/Research/QuickPay/Data-and-code/replication_codes_v1/code/qp_revision/w_qp_timeline_2008.rds")
```
