...
```{r}
df_2008_1=fread(paste0(folder,"FY2008_097_Contracts_Full_20200205/FY2008_097_Contracts_Full_20200206_1.csv"),
          select = keep_cols)
  
df_2008_2=fread(paste0(folder,"FY2008_097_Contracts_Full_20200205/FY2008_097_Contracts_Full_20200206_2.csv"),
          select = keep_cols)

df_2009_1=fread(paste0(folder,"FY2009_097_Contracts_Full_20200205/FY2009_097_Contracts_Full_20200206_1.csv"),
          select = keep_cols)
  
df_2009_2=fread(paste0(folder,"FY2009_097_Contracts_Full_20200205/FY2009_097_Contracts_Full_20200206_2.csv"),
          select = keep_cols)

df_2010_1=fread(paste0(folder,
                 "FY2010_097_Contracts_Full_20200205/FY2010_097_Contracts_Full_20200206_1.csv"),
          select = keep_cols)
df_2010_2=fread(paste0(folder,
                 "FY2010_097_Contracts_Full_20200205/FY2010_097_Contracts_Full_20200206_2.csv"),
          select = keep_cols)
df_2011_1=fread(paste0(folder,
                 "FY2011_097_Contracts_Full_20200205/FY2011_097_Contracts_Full_20200206_1.csv"),
          select = keep_cols)
df_2011_2=fread(paste0(folder,
                 "FY2011_097_Contracts_Full_20200205/FY2011_097_Contracts_Full_20200206_2.csv"),
          select = keep_cols)
df_2012_1=fread(paste0(folder,
                 "FY2012_097_Contracts_Full_20200205/FY2012_097_Contracts_Full_20200206_1.csv"),
          select = keep_cols)
df_2012_2=fread(paste0(folder,
                 "FY2012_097_Contracts_Full_20200205/FY2012_097_Contracts_Full_20200206_2.csv"),
          select = keep_cols)

df_list=list(df_2008_1,
             df_2008_2,
             df_2009_1,
             df_2009_2,
             df_2010_1,
