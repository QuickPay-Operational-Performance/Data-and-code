...
reg_df[,delay:=fifelse(contract_award_unique_key==lag(contract_award_unique_key),
                       ...
                       NaN)]
reg_df[,wins_delay:=Winsorize(delay,val=quantile(delay,probs=c(0.05,0.95),na.rm=T))]
...
reg_df[,wins_relative_delay:=Winsorize(relative_delay,val=quantile(relative_delay,probs=c(0.05,0.95),na.rm=T))]
