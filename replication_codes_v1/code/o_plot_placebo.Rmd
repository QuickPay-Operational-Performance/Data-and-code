...
treatment_group_placebo_density=ggplot(placebo_reg_table, 
       aes(x = estimate, 
           fill = p.value<0.05)) + 
  geom_histogram(colour = "black",
                 ...
                 position = "identity",
                 bins = 50) + 
    scale_fill_manual(labels = setNames(c("p<0.05", "p>0.05"),
                                          c(T, F)), 
                        values = setNames(c('darkgray',
                                            'white'),
                                          c(T, F)))+
    theme_minimal() +
    ...
    xlab("Estimate (Percentage delay)") +
    ylab("")+
    labs(color = "")
...
ggsave(paste0(output_folder,
              'treatment_group_placebo_density.png'),
       treatment_group_placebo_density,
       bg="white",
       width=10)
```
