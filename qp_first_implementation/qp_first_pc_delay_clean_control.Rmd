---
title: "Percentage Delay Rate (with Clean Control): QuickPay (2009-2012)"
...
treated_projs_preqp=subset(reg_df_subset,treat_new==1 & post_t==0)
control_projs_preqp=subset(reg_df_subset,treat_new==0 & post_t==0)
...
treated_projs_postqp=subset(reg_df_subset,treat_new==1 & post_t==1)
control_projs_postqp=subset(reg_df_subset,treat_new==0 & post_t==1)
