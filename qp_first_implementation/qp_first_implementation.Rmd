...
```{r pba_all, echo=FALSE, results='asis'}
# Baseline Regressions 
baseline_reg=felm(winsorized_delay~treat_i+
                    ...
                    post_t:treat_i:performance_based_contract_i|
                    0| # no fixed effects
                    0| # no IV
                    contract_award_unique_key, # clustered at project level
                  data=reg_df, 
...
stargazer(baseline_reg,
          ...
          digits=2,
          digits.extra=2,
          title = "Effect of Performance Incentives: Quickpay 2009-2011",
          dep.var.labels="$Delay_{it}$ (in days)",
          dep.var.caption = "",
          order=paste0("^", vars.order , "$"),
          covariate.labels = c("$Treat_i$",
                               ...
                               "$Treat_i \\times Post_t$",
                               "$PerformanceBased_i$",
                               "$Post_t \\times PerformanceBased_i$",
                               "$Post_t \\times PerformanceBased_i \\times Treat_i$",
                               "Constant"),
          object.names=FALSE, 
          model.numbers=TRUE,
          font.size = "small",
...
## Subsample: Projects active both before and after Quickpay

```{r pba_subsample, echo=FALSE, results='asis'}
...
stargazer(baseline_reg,
          ...
          notes=c("Each observation is a project-quarter.",
                  "SEs are robust and clustered at the project level.",
                  "Sample restricted to projects active both before and after quickpay."),
          header=F)
```
...
```{r competition_all, echo=FALSE, results='asis'}
# Baseline Regressions 
baseline_reg=felm(winsorized_delay~treat_i+
                    post_t:treat_i+
                    post_t+
                    ...
                    post_t:treat_i:competitively_awarded_i|
                    0| # no fixed effects
                    0| # no IV
                    contract_award_unique_key, # clustered at project level
                  data=reg_df, 
...
stargazer(baseline_reg,
          ...
          covariate.labels = c("$Treat_i$",
                               ...
                               "$Treat_i \\times Post_t$",
                               "$Competition_i$",
                               "$Post_t \\times Competition_i$",
                               "$Post_t \\times Competition_i \\times Treat_i$",
                               "Constant"),
          object.names=FALSE, 
          model.numbers=TRUE,
          font.size = "small",
...
```{r competition_subsample, echo=FALSE, results='asis'}
