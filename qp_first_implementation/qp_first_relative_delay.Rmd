...
reg_df=subset(reg_df,initial_duration_in_days_i>0)
# get project duration as of last quarter in the denominator
reg_df[,relative_delay:=delay/(initial_duration_in_days_i)]
...
reg_df_one_type[,wins_relative_delay:=Winsorize(100*relative_delay,                    
                              probs=c(0.05,0.95),
                              na.rm=T)]
...
ggplot(mean_delay, aes(x=year_quarter,
    ...
    annotate("text", label = "QuickPay\n implemented", x = 8, y = 0.15,color="dimgrey")+
...
write(base_table_tex,
      paste0(tables_folder,"/base_table_relative_delay.tex"))
...
# Write to file
write(base_table_tex,
      paste0(tables_folder,"/base_table_relative_delay_one_type.tex"))
