...
var\_name & SB.before & LB.before & SB.after & LB.after \\ 
  \midrule
Number of tasks & 786 & 707 & 947 & 900 \\ 
  Number of industries & 64 & 65 & 62 & 64 \\ 
   \bottomrule
\end{tabular}
}
\end{table}
...
\hypertarget{sample-restricted-to-projects-active-before-qp}{%
\subsection{Sample restricted to projects active before
QP}\label{sample-restricted-to-projects-active-before-qp}}
...
\\[-1.8ex] & (1) & (2) & (3) & (4) & (5)\\ 
\hline \\[-1.8ex] 
 $Treat_i$ & $-$1.76$^{***}$ & $-$1.29$^{***}$ & $-$1.35$^{***}$ & $-$0.79$^{***}$ & $-$0.82$^{***}$ \\ 
  & (0.11) & (0.11) & (0.11) & (0.11) & (0.11) \\ 
  & & & & & \\ 
 $Post_t$ & 0.63$^{***}$ & $-$6.17$^{***}$ &  &  &  \\ 
  & (0.14) & (1.07) &  &  &  \\ 
  & & & & & \\ 
 $Treat_i \times Post_t$ & 0.90$^{***}$ & 1.51$^{***}$ & 1.64$^{***}$ & 1.39$^{***}$ & 1.38$^{***}$ \\ 
...
Task fixed effects & No & No & No & Yes & Yes \\ 
Industry fixed effects & No & No & No & No & Yes \\ 
Observations & 147,983 & 130,615 & 130,615 & 130,615 & 130,615 \\ 
R$^{2}$ & 0.004 & 0.17 & 0.17 & 0.21 & 0.21 \\ 
Adjusted R$^{2}$ & 0.004 & 0.17 & 0.17 & 0.21 & 0.21 \\ 
\hline 
\hline \\[-1.8ex] 
\textit{Note:}  & \multicolumn{5}{r}{$^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01} \\ 
 & \multicolumn{5}{r}{Each observation is a project-quarter.} \\ 
 & \multicolumn{5}{r}{SEs are robust and clustered at the project level.} \\ 
 & \multicolumn{5}{r}{Sample restricted to projects that started before QP.} \\ 
\end{tabular} 
\end{table}
...
\tightlist
\item
  Treat\_Intensity\_i = Treat\_i x log(Budget of project i)
\item
  This measures how much a contractor is affected by QuickPay
\item
  The interaction term roughly tells us the additional delay on a given
  project for every dollar that the contractor earns the small project.
\item
...
\\[-1.8ex] & (1) & (2) & (3) & (4) & (5)\\ 
\hline \\[-1.8ex] 
 $TreatIntensity_i$ (Budget) & $-$0.11$^{***}$ & $-$0.07$^{***}$ & $-$0.08$^{***}$ & $-$0.04$^{***}$ & $-$0.05$^{***}$ \\ 
  & (0.01) & (0.01) & (0.01) & (0.01) & (0.01) \\ 
  & & & & & \\ 
 $Post_t$ & 0.64$^{***}$ & $-$5.24$^{***}$ &  &  &  \\ 
  & (0.13) & (1.06) &  &  &  \\ 
  & & & & & \\ 
 $TreatIntensity_i$ (Budget) $\times Post_t$ & 0.09$^{***}$ & 0.13$^{***}$ & 0.15$^{***}$ & 0.12$^{***}$ & 0.12$^{***}$ \\ 
  & (0.01) & (0.01) & (0.01) & (0.01) & (0.01) \\ 
  & & & & & \\ 
 Constant & 4.88$^{***}$ & 48.64$^{***}$ &  &  &  \\ 
  & (0.09) & (0.61) &  &  &  \\ 
...
Industry fixed effects & No & No & No & No & Yes \\ 
Observations & 147,983 & 130,615 & 130,615 & 130,615 & 130,615 \\ 
R$^{2}$ & 0.003 & 0.15 & 0.16 & 0.21 & 0.21 \\ 
Adjusted R$^{2}$ & 0.003 & 0.15 & 0.16 & 0.20 & 0.21 \\ 
\hline 
\hline \\[-1.8ex] 
\textit{Note:}  & \multicolumn{5}{r}{$^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01} \\ 
 & \multicolumn{5}{r}{Each observation is a project-quarter.} \\ 
...
\hypertarget{did-on-large-projects}{%
\subsection{DID on large projects}\label{did-on-large-projects}}
...
\item
  Indirect Treat = 1 if Treat\_i = 0 and number of small projects
  \textgreater{} 0
\item
  Indirect\_treat\_intensity = Indirect Treat x log(1+number of small
  projects)
\item
  Subset of large projects only
\end{itemize}

\hypertarget{did-on-small-projects-portfolio-treat}{%
\subsection{DID on small projects (Portfolio
Treat)}\label{did-on-small-projects-portfolio-treat}}

\begin{itemize}
\tightlist
\item
  PortfolioTreat\_i = 1 if small project i has a concurrent large
  project.
\item
  Treat\_i = 1 if project i is a small project.
\end{itemize}
...
\\[-1.8ex] & (1) & (2) & (3) & (4) & (5)\\ 
\hline \\[-1.8ex] 
 $Treat_i$ (All Small) & $-$0.79$^{***}$ & $-$0.48$^{***}$ & $-$0.54$^{***}$ & $-$0.68$^{***}$ & $-$0.71$^{***}$ \\ 
  & (0.13) & (0.11) & (0.11) & (0.12) & (0.12) \\ 
  & & & & & \\ 
 $PortfolioTreat_i$ (Small with Large) & $-$2.74$^{***}$ & $-$2.46$^{***}$ & $-$2.41$^{***}$ & $-$0.72$^{***}$ & $-$0.64$^{***}$ \\ 
  & (0.11) & (0.10) & (0.10) & (0.10) & (0.10) \\ 
  & & & & & \\ 
 $Post_t$ & $-$0.21$^{*}$ & $-$5.41$^{***}$ &  &  &  \\ 
  & (0.12) & (0.79) &  &  &  \\ 
  & & & & & \\ 
 $Treat_i$ (All Small) $\times Post_t$ & 1.22$^{***}$ & 1.04$^{***}$ & 1.09$^{***}$ & 1.11$^{***}$ & 1.13$^{***}$ \\ 
  & (0.15) & (0.15) & (0.15) & (0.15) & (0.15) \\ 
  & & & & & \\ 
 $PortfolioTreat_i$ (Small with Large) $\times Post_t$ & $-$0.48$^{***}$ & $-$0.28$^{**}$ & $-$0.33$^{**}$ & $-$0.38$^{***}$ & $-$0.38$^{***}$ \\ 
...
\hypertarget{did-on-small-projects-treatment-intensity}{%
\subsection{DID on small projects (Treatment
Intensity)}\label{did-on-small-projects-treatment-intensity}}
...
\tightlist
\item
  Treat\_Intensity\_i = Treat\_i x log(1 + number of small projects)
\item
  Treat\_Intensity\_i (Small with large) = I(Contractor holds large
  projects) x Treat\_i x log(1 + number of small projects)
\item
  Treat\_Intensity\_Large\_i = Treat\_i x log(1 + number of large
  projects)
\end{itemize}
