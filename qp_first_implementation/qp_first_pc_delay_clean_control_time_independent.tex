...
\tightlist
\item
  For contractor k, define Treat\_Intensity\_k = Treat x (Budget of all
  small projects before QP)/(Budget of all projects before QP)
\item
...
\item
  ...
  project for every dollar that the contractor earns from small
  projects.
\end{itemize}
...
\\[-1.8ex] & (1) & (2) & (3) & (4) & (5)\\ 
\hline \\[-1.8ex] 
 $TreatIntensity_i$ (Budget) & $-$0.85$^{***}$ & $-$0.38$^{***}$ & $-$0.44$^{***}$ & $-$0.51$^{***}$ & $-$0.52$^{***}$ \\ 
  & (0.12) & (0.11) & (0.11) & (0.11) & (0.11) \\ 
  & & & & & \\ 
 $Post_t$ & $-$0.08 & $-$6.24$^{***}$ &  &  &  \\ 
  & (0.11) & (0.80) &  &  &  \\ 
  & & & & & \\ 
 $TreatIntensity_i$ (Budget) $\times Post_t$ & 0.88$^{***}$ & 0.69$^{***}$ & 0.75$^{***}$ & 0.93$^{***}$ & 0.97$^{***}$ \\ 
...
Task fixed effects & No & No & No & Yes & Yes \\ 
Industry fixed effects & No & No & No & No & Yes \\ 
Observations & 202,844 & 182,890 & 182,890 & 182,890 & 182,890 \\ 
R$^{2}$ & 0.001 & 0.17 & 0.17 & 0.21 & 0.22 \\ 
