...
\tightlist
\item
  TreatIntensity\_i = Treat x log(1+ number of large projects)
\end{itemize}
...
\\[-1.8ex] & (1) & (2) & (3) & (4) & (5)\\ 
\hline \\[-1.8ex] 
 $TreatIntensity_i$ & $-$0.92$^{***}$ & $-$0.68$^{***}$ & $-$0.67$^{***}$ & $-$0.28$^{***}$ & $-$0.27$^{***}$ \\ 
  & (0.04) & (0.04) & (0.04) & (0.03) & (0.03) \\ 
  & & & & & \\ 
 $Post_t$ & 0.51$^{***}$ & $-$4.40$^{***}$ &  &  &  \\ 
  & (0.07) & (0.75) &  &  &  \\ 
  & & & & & \\ 
 $TreatIntensity_i \times Post_t$ & $-$0.13$^{***}$ & $-$0.06 & $-$0.07 & $-$0.09$^{*}$ & $-$0.07 \\ 
