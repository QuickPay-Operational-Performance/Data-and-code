...
left_and_right_censored=subset(reg_df,wins_percentage_delay!=0 & wins_percentage_delay<175)
hist(left_and_right_censored$wins_percentage_delay,freq=FALSE, main='Density plot: 0<Percentage Delay<175')
```
...
```{r reg_output, ,echo=FALSE, results='asis'}
texreg(list(m1,m2), 
