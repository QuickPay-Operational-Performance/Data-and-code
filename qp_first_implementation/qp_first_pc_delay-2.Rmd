...
## Normalized percentage delay: Four groups

```{r normalized_four_groups, echo=FALSE, results='asis'}
...
## Regression 4B: Number of Large Projects
...
```{r project_portfolio_num_large_clean_control, warning=FALSE, echo=FALSE, results='asis'}
m1=felm(wins_percentage_delay~treat_small_with_large+
                    post_t:treat_small_with_large+
                     post_t+
                    num_large_projects+
...
baseline_reg=felm(wins_percentage_delay~treat_i+
                     ...
                     post_t|
                                   ...
                                   0| # no IV
                                   contract_award_unique_key, # clustered at project level
                                   data=subset(reg_df,recipient_duns%in%one_type_contractors),
                                   exactDOF = TRUE,
                                   cmethod = "reghdfe")
controls_and_no_fe_no_age=felm(wins_percentage_delay~treat_i+
                                   project_signed_after_quickpay+
