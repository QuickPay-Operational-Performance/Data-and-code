...
contractor_one_type=reg_df[,n_distinct(treat_i),by='recipient_duns']
contractor_one_type=unique(subset(contractor_one_type,V1==1& !is.na(recipient_duns))$recipient_duns)
active_before_qp=unique(subset(reg_df,post_t==0)$recipient_duns)

reg_df_one_type=subset(reg_df,recipient_duns%in%contractor_one_type)
