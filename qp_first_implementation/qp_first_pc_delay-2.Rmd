...
### Intensity with Number of Small Projects

```{r project_portfolio_spillover_intensity, echo=FALSE,results='asis',warning=FALSE}
...
```{r project_portfolio_spillover_1,warning=FALSE, echo=FALSE, results='asis'}
...
## Regression 4A: Indicator for Parallel Large Project
...
```{r project_portfolio_parallel_large,warning=FALSE, echo=FALSE, results='asis'}
