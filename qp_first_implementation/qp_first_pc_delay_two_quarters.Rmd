...
mean_delay=reg_df[!is.na(winsorized_two_quarter_delay), 
              ...
              by = c('new_quarter_date','business_type')]
mean_delay[,year_quarter:=format(new_quarter_date,"%Y-%b")]
mean_delay=mean_delay[order(new_quarter_date,business_type)]
...
controls_time_task_fe=felm(winsorized_two_quarter_delay~treat_i+
                        ...
                        #   project_quarter_tercile+
                            ...
                            post_t:winsorized_initial_budget_i+
                            post_t:number_of_offers_received|
                            product_or_service_code+new_quarter_date|
                            0|
                            contract_award_unique_key,
                          data=reg_df, 
                          exactDOF = TRUE, 
...
controls_and_all_fe=felm(winsorized_two_quarter_delay~treat_i+
                        ...
                        #   project_quarter_tercile+
                            ...
                            post_t:winsorized_initial_budget_i+
                            post_t:number_of_offers_received|
                            recipient_duns+product_or_service_code+new_quarter_date|
                            0|
                            contract_award_unique_key,
                          data=reg_df, 
                          exactDOF = TRUE, 
