...
```{r remove_zeros_and_winsorize,include=FALSE}

reg_df=subset(reg_df,delay!=0)

reg_df[,winsorized_delay:=Winsorize(delay,na.rm=T)]
...
ggplot(mean_delay, aes(x=year_quarter,
    ...
    annotate("text", label = "QuickPay\n implemented", x = 8, y = 10,color="dimgrey")+
