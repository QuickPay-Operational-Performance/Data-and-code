...
reg_df_positive=subset(reg_df_one_type,percentage_delay>0 & !is.infinite(percentage_delay))
...
reg_df_negative=subset(reg_df_one_type,percentage_delay<0 & !is.infinite(percentage_delay))
...
reg_df_non_zero=subset(reg_df_one_type,percentage_delay!=0 & !is.infinite(percentage_delay))
...
reg_df_non_zero[,wins_project_quarter_stage:=Winsorize(project_quarter_stage,                    
                              ...
                              na.rm=T)]
```
# Percentage delays over time -- One type
...
## Normalized delay rate (in percentage) -- One type
...
write(base_table_tex,
      paste0(tables_folder,"/base_table_non_zero_one_type.tex"))

```

## Positive Delays -- One type
...
# Write to file
write(base_table_tex,
      paste0(tables_folder,"/base_table_positive_one_type.tex"))
...
# Write to file
write(base_table_tex,
      paste0(tables_folder,"/base_table_negative_one_type.tex"))
