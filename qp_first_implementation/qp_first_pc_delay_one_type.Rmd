...
* This is for all projects, because no spillover issue with project-level competition metrics (unlike delays).
* That is, contractors would make aggressive bids on their small projects (to receive faster payment) regardless of other projects in their portfolio.
