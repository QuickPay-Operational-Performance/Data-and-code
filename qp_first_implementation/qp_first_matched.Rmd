...
df_first_reported[,initial_duration_in_days_i:=as.numeric(
                               as.Date(period_of_performance_current_end_date)-
                               as.Date(period_of_performance_start_date))]

df_first_reported[,winsorized_initial_duration_in_days_i:=Winsorize(initial_duration_in_days_i,
                  na.rm=T)]
...
df_first_reported_cols[,initial_start_date:=period_of_performance_start_date]
...
```{r normalized_plot,eval=FALSE, include=FALSE}
...
```{r parallel_trends_test, echo=FALSE, eval=FALSE}
...
base_table=stargazer(baseline_reg,
          ...
          controls_and_all_fe,
          title = "Quickpay 2009-2011",
          dep.var.labels="$PercentDelay_{it}$ (clean control)",
          dep.var.caption = "",
          covariate.labels = c("$Treat_i$","$Post_t$","$Treat_i \\times Post_t$","Constant"),
          object.names=FALSE, 
          model.numbers=TRUE,
