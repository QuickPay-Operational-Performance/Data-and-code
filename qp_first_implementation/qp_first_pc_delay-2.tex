...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{reg\_df\_placebo}\OtherTok{=}\FunctionTok{subset}\NormalTok{(reg\_df,post\_t}\SpecialCharTok{==}\DecValTok{0}\NormalTok{)}

\NormalTok{reg\_df\_placebo[,wins\_percentage\_delay}\SpecialCharTok{:}\ErrorTok{=}\FunctionTok{Winsorize}\NormalTok{(}\DecValTok{100}\SpecialCharTok{*}\NormalTok{percentage\_delay,}
                               \AttributeTok{probs=}\FunctionTok{c}\NormalTok{(}\FloatTok{0.025}\NormalTok{,}\FloatTok{0.975}\NormalTok{),}
                               \AttributeTok{na.rm=}\NormalTok{T)]}

\NormalTok{reg\_df\_placebo[,wins\_project\_quarter\_stage}\SpecialCharTok{:}\ErrorTok{=}\FunctionTok{Winsorize}\NormalTok{(project\_quarter\_stage,                    }
                              \AttributeTok{probs=}\FunctionTok{c}\NormalTok{(}\FloatTok{0.05}\NormalTok{,}\FloatTok{0.95}\NormalTok{),}
                              \AttributeTok{na.rm=}\NormalTok{T)]}

\NormalTok{reg\_df\_placebo[,winsorized\_initial\_duration\_in\_days\_i}\SpecialCharTok{:}\ErrorTok{=}
                    \FunctionTok{Winsorize}\NormalTok{(initial\_duration\_in\_days\_i,}
                    \AttributeTok{probs=}\FunctionTok{c}\NormalTok{(}\FloatTok{0.025}\NormalTok{,}\FloatTok{0.975}\NormalTok{),}
                    \AttributeTok{na.rm=}\NormalTok{T)]}

\CommentTok{\# InitialBudget\_i}

\NormalTok{reg\_df\_placebo[,winsorized\_initial\_budget\_i}\SpecialCharTok{:}\ErrorTok{=}
                    \FunctionTok{Winsorize}\NormalTok{(base\_and\_all\_options\_value,                    }
                              \AttributeTok{probs=}\FunctionTok{c}\NormalTok{(}\FloatTok{0.025}\NormalTok{,}\FloatTok{0.975}\NormalTok{),}
                              \AttributeTok{na.rm=}\NormalTok{T)]}

\CommentTok{\# use winsorized delay because fewer quarters \& percentage delay requires project to be active for at least two quarters}
\NormalTok{df\_main}\OtherTok{=}\FunctionTok{data.frame}\NormalTok{()}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{3}\SpecialCharTok{:}\DecValTok{5}\NormalTok{)\{}
\CommentTok{\#  print(i)}
  \FunctionTok{tryCatch}\NormalTok{(\{}
\NormalTok{  reg\_df\_placebo[,placebo\_post\_t}\SpecialCharTok{:}\ErrorTok{=}\FunctionTok{ifelse}\NormalTok{(quarter\_number}\SpecialCharTok{\textgreater{}=}\NormalTok{i,}\DecValTok{1}\NormalTok{,}\DecValTok{0}\NormalTok{)]  }
\NormalTok{  a1}\OtherTok{=}\FunctionTok{tidy}\NormalTok{(}\FunctionTok{felm}\NormalTok{(wins\_percentage\_delay}\SpecialCharTok{\textasciitilde{}}\NormalTok{treat\_i}\SpecialCharTok{+}
\NormalTok{                treat\_i}\SpecialCharTok{:}\NormalTok{placebo\_post\_t}\SpecialCharTok{+}
\NormalTok{                placebo\_post\_t}\SpecialCharTok{|}
                \DecValTok{0}\SpecialCharTok{|}
                \DecValTok{0}\SpecialCharTok{|}
\NormalTok{                contract\_award\_unique\_key,}
              \AttributeTok{data=}\NormalTok{reg\_df\_placebo,}
              \AttributeTok{exactDOF =} \ConstantTok{TRUE}\NormalTok{, }
              \AttributeTok{cmethod =} \StringTok{"reghdfe"}\NormalTok{),}
              \AttributeTok{conf.int=}\NormalTok{T)}
\NormalTok{    a2}\OtherTok{=}\FunctionTok{tidy}\NormalTok{(}\FunctionTok{felm}\NormalTok{(wins\_percentage\_delay}\SpecialCharTok{\textasciitilde{}}\NormalTok{treat\_i}\SpecialCharTok{+}
\NormalTok{                treat\_i}\SpecialCharTok{:}\NormalTok{placebo\_post\_t}\SpecialCharTok{+}
\NormalTok{                placebo\_post\_t}\SpecialCharTok{+}  
                \FunctionTok{log}\NormalTok{(wins\_project\_quarter\_stage)}\SpecialCharTok{+}
                \FunctionTok{log}\NormalTok{(}\DecValTok{1}\SpecialCharTok{+}\NormalTok{winsorized\_initial\_duration\_in\_days\_i)}\SpecialCharTok{+}
                \FunctionTok{log}\NormalTok{(}\DecValTok{1}\SpecialCharTok{+}\NormalTok{winsorized\_initial\_budget\_i)}\SpecialCharTok{+}
\NormalTok{                number\_of\_offers\_received}\SpecialCharTok{+}
\NormalTok{                placebo\_post\_t}\SpecialCharTok{:}\FunctionTok{log}\NormalTok{(}\DecValTok{1}\SpecialCharTok{+}\NormalTok{winsorized\_initial\_duration\_in\_days\_i)}\SpecialCharTok{+}
\NormalTok{                placebo\_post\_t}\SpecialCharTok{:}\FunctionTok{log}\NormalTok{(}\DecValTok{1}\SpecialCharTok{+}\NormalTok{winsorized\_initial\_budget\_i)}\SpecialCharTok{+}
\NormalTok{                placebo\_post\_t}\SpecialCharTok{:}\NormalTok{number\_of\_offers\_received}\SpecialCharTok{|}
                \DecValTok{0}\SpecialCharTok{|}
                \DecValTok{0}\SpecialCharTok{|}
\NormalTok{                contract\_award\_unique\_key,}
              \AttributeTok{data=}\NormalTok{reg\_df\_placebo,}
              ...
              \AttributeTok{cmethod =} \StringTok{"reghdfe"}\NormalTok{),}
              \AttributeTok{conf.int=}\NormalTok{T)}
\NormalTok{      a3}\OtherTok{=}\FunctionTok{tidy}\NormalTok{(}\FunctionTok{felm}\NormalTok{(wins\_percentage\_delay}\SpecialCharTok{\textasciitilde{}}\NormalTok{treat\_i}\SpecialCharTok{+}
\NormalTok{                treat\_i}\SpecialCharTok{:}\NormalTok{placebo\_post\_t}\SpecialCharTok{+}
                \FunctionTok{log}\NormalTok{(wins\_project\_quarter\_stage)}\SpecialCharTok{+}
                \FunctionTok{log}\NormalTok{(}\DecValTok{1}\SpecialCharTok{+}\NormalTok{winsorized\_initial\_duration\_in\_days\_i)}\SpecialCharTok{+}
                \FunctionTok{log}\NormalTok{(}\DecValTok{1}\SpecialCharTok{+}\NormalTok{winsorized\_initial\_budget\_i)}\SpecialCharTok{+}
...
\NormalTok{                placebo\_post\_t}\SpecialCharTok{:}\FunctionTok{log}\NormalTok{(}\DecValTok{1}\SpecialCharTok{+}\NormalTok{winsorized\_initial\_budget\_i)}\SpecialCharTok{+}
\NormalTok{                placebo\_post\_t}\SpecialCharTok{:}\NormalTok{number\_of\_offers\_received}\SpecialCharTok{|}
\NormalTok{                action\_date\_year\_quarter}\SpecialCharTok{|}
                \DecValTok{0}\SpecialCharTok{|}
\NormalTok{                contract\_award\_unique\_key,}
              \AttributeTok{data=}\NormalTok{reg\_df\_placebo,}
              \AttributeTok{exactDOF =} \ConstantTok{TRUE}\NormalTok{, }
              \AttributeTok{cmethod =} \StringTok{"reghdfe"}\NormalTok{),}
              \AttributeTok{conf.int=}\NormalTok{T)}
\NormalTok{        a4}\OtherTok{=}\FunctionTok{tidy}\NormalTok{(}\FunctionTok{felm}\NormalTok{(wins\_percentage\_delay}\SpecialCharTok{\textasciitilde{}}\NormalTok{treat\_i}\SpecialCharTok{+}
\NormalTok{                treat\_i}\SpecialCharTok{:}\NormalTok{placebo\_post\_t}\SpecialCharTok{+}
                \FunctionTok{log}\NormalTok{(wins\_project\_quarter\_stage)}\SpecialCharTok{+}
                \FunctionTok{log}\NormalTok{(}\DecValTok{1}\SpecialCharTok{+}\NormalTok{winsorized\_initial\_duration\_in\_days\_i)}\SpecialCharTok{+}
                \FunctionTok{log}\NormalTok{(}\DecValTok{1}\SpecialCharTok{+}\NormalTok{winsorized\_initial\_budget\_i)}\SpecialCharTok{+}
...
\NormalTok{                placebo\_post\_t}\SpecialCharTok{:}\FunctionTok{log}\NormalTok{(}\DecValTok{1}\SpecialCharTok{+}\NormalTok{winsorized\_initial\_budget\_i)}\SpecialCharTok{+}
\NormalTok{                placebo\_post\_t}\SpecialCharTok{:}\NormalTok{number\_of\_offers\_received}\SpecialCharTok{|}
\NormalTok{                product\_or\_service\_code}\SpecialCharTok{+}
\NormalTok{                action\_date\_year\_quarter}\SpecialCharTok{|}
                \DecValTok{0}\SpecialCharTok{|}
\NormalTok{                contract\_award\_unique\_key,}
              \AttributeTok{data=}\NormalTok{reg\_df\_placebo,}
              ...
              \AttributeTok{cmethod =} \StringTok{"reghdfe"}\NormalTok{),}
              \AttributeTok{conf.int=}\NormalTok{T)}
\NormalTok{        a5}\OtherTok{=}\FunctionTok{tidy}\NormalTok{(}\FunctionTok{felm}\NormalTok{(wins\_percentage\_delay}\SpecialCharTok{\textasciitilde{}}\NormalTok{treat\_i}\SpecialCharTok{+}
\NormalTok{                treat\_i}\SpecialCharTok{:}\NormalTok{placebo\_post\_t}\SpecialCharTok{+}
                \FunctionTok{log}\NormalTok{(wins\_project\_quarter\_stage)}\SpecialCharTok{+}
                \FunctionTok{log}\NormalTok{(}\DecValTok{1}\SpecialCharTok{+}\NormalTok{winsorized\_initial\_duration\_in\_days\_i)}\SpecialCharTok{+}
                \FunctionTok{log}\NormalTok{(}\DecValTok{1}\SpecialCharTok{+}\NormalTok{winsorized\_initial\_budget\_i)}\SpecialCharTok{+}
...
\NormalTok{                placebo\_post\_t}\SpecialCharTok{:}\FunctionTok{log}\NormalTok{(}\DecValTok{1}\SpecialCharTok{+}\NormalTok{winsorized\_initial\_budget\_i)}\SpecialCharTok{+}
\NormalTok{                placebo\_post\_t}\SpecialCharTok{:}\NormalTok{number\_of\_offers\_received}\SpecialCharTok{|}
\NormalTok{                naics\_code}\SpecialCharTok{+}
\NormalTok{                product\_or\_service\_code}\SpecialCharTok{+}
\NormalTok{                action\_date\_year\_quarter}\SpecialCharTok{|}
                \DecValTok{0}\SpecialCharTok{|}
\NormalTok{                contract\_award\_unique\_key,}
              ...
              \AttributeTok{cmethod =} \StringTok{"reghdfe"}\NormalTok{),}
              \AttributeTok{conf.int=}\NormalTok{T)}
\NormalTok{    a1}\OtherTok{=}\FunctionTok{subset}\NormalTok{(a1,term}\SpecialCharTok{==}\StringTok{\textquotesingle{}treat\_i:placebo\_post\_t\textquotesingle{}}\NormalTok{)}
\NormalTok{    a2}\OtherTok{=}\FunctionTok{subset}\NormalTok{(a2,term}\SpecialCharTok{==}\StringTok{\textquotesingle{}treat\_i:placebo\_post\_t\textquotesingle{}}\NormalTok{)}
\NormalTok{    a3}\OtherTok{=}\FunctionTok{subset}\NormalTok{(a3,term}\SpecialCharTok{==}\StringTok{\textquotesingle{}treat\_i:placebo\_post\_t\textquotesingle{}}\NormalTok{)}
\NormalTok{    a4}\OtherTok{=}\FunctionTok{subset}\NormalTok{(a4,term}\SpecialCharTok{==}\StringTok{\textquotesingle{}treat\_i:placebo\_post\_t\textquotesingle{}}\NormalTok{)}
\NormalTok{    a5}\OtherTok{=}\FunctionTok{subset}\NormalTok{(a5,term}\SpecialCharTok{==}\StringTok{\textquotesingle{}treat\_i:placebo\_post\_t\textquotesingle{}}\NormalTok{)}
\NormalTok{    a}\OtherTok{=}\FunctionTok{rbind}\NormalTok{(a1,a2,a3,a4,a5)}
\NormalTok{    a[}\StringTok{\textquotesingle{}Placebo Treatment Time\textquotesingle{}}\NormalTok{]}\OtherTok{=} \FunctionTok{unique}\NormalTok{(}\FunctionTok{subset}\NormalTok{(reg\_df\_placebo,}
\NormalTok{                                        quarter\_number}\SpecialCharTok{==}\NormalTok{i)}\SpecialCharTok{$}\NormalTok{action\_date\_year\_quarter)}
    \FunctionTok{assign}\NormalTok{(}\FunctionTok{paste0}\NormalTok{(}\StringTok{"df"}\NormalTok{, i), }\AttributeTok{value =}\NormalTok{ a)}
\NormalTok{    df\_main}\OtherTok{=}\FunctionTok{rbind}\NormalTok{(df\_main,}\FunctionTok{get}\NormalTok{(}\FunctionTok{paste0}\NormalTok{(}\StringTok{"df"}\NormalTok{, i)))\}, }\AttributeTok{error=}\ControlFlowTok{function}\NormalTok{(e)\{\})}
\NormalTok{\}}

\FunctionTok{setDT}\NormalTok{(df\_main)[,reg\_number}\SpecialCharTok{:}\ErrorTok{=}\FunctionTok{as.factor}\NormalTok{(}\FunctionTok{seq.int}\NormalTok{(}\FunctionTok{nrow}\NormalTok{(df\_main)))]}

\FunctionTok{ggplot}\NormalTok{(df\_main,}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{reg\_number,}
                            \AttributeTok{y=}\NormalTok{estimate,}
                            \AttributeTok{group=}\DecValTok{1}\NormalTok{))}\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{size=}\DecValTok{1}\NormalTok{,}\AttributeTok{alpha=}\FloatTok{0.7}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{geom\_errorbar}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{ymin =}\NormalTok{ conf.low, }
                ...
                \AttributeTok{width=}\FloatTok{0.015}\NormalTok{,}
                \AttributeTok{size=}\FloatTok{0.25}\NormalTok{,}
                \AttributeTok{alpha=}\FloatTok{0.7}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{geom\_hline}\NormalTok{(}\AttributeTok{yintercept =}\DecValTok{0}\NormalTok{,}\AttributeTok{alpha=}\FloatTok{0.6}\NormalTok{,}\AttributeTok{size=}\FloatTok{0.15}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{theme\_minimal}\NormalTok{()}\SpecialCharTok{+} 
  \FunctionTok{theme}\NormalTok{(}\AttributeTok{panel.border =} \FunctionTok{element\_rect}\NormalTok{(}\AttributeTok{color=}\StringTok{"black"}\NormalTok{,}\AttributeTok{fill=}\ConstantTok{NA}\NormalTok{), }
  ...
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"Point estimate }\SpecialCharTok{\textbackslash{}n}\StringTok{ (Percentage Delay Rate)"}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{xlab}\NormalTok{(}\StringTok{""}\NormalTok{)}\SpecialCharTok{+}
  \CommentTok{\#ylim({-}1.05, 2.5)+ }
  \FunctionTok{coord\_fixed}\NormalTok{(}\AttributeTok{ratio=}\FloatTok{0.7}\NormalTok{)}
\FunctionTok{grid.brackets}\NormalTok{(}\DecValTok{184}\NormalTok{, }\DecValTok{195}\NormalTok{, }\DecValTok{56}\NormalTok{, }\DecValTok{195}\NormalTok{, }\AttributeTok{type =} \DecValTok{1}\NormalTok{)}
\FunctionTok{grid.text}\NormalTok{(}\AttributeTok{x=}\FunctionTok{unit}\NormalTok{(}\DecValTok{125}\NormalTok{,}\StringTok{\textquotesingle{}native\textquotesingle{}}\NormalTok{), }\AttributeTok{y=}\FunctionTok{unit}\NormalTok{(}\DecValTok{220}\NormalTok{,}\StringTok{\textquotesingle{}native\textquotesingle{}}\NormalTok{),}
  \AttributeTok{label=}\FunctionTok{expression}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{\textquotesingle{}Jun{-}2010\textquotesingle{}}\NormalTok{),}\AttributeTok{just =} \StringTok{"centre"}\NormalTok{,}\StringTok{\textquotesingle{}type=4\textquotesingle{}}\NormalTok{))}
\FunctionTok{grid.brackets}\NormalTok{(}\DecValTok{330}\NormalTok{, }\DecValTok{195}\NormalTok{, }\DecValTok{200}\NormalTok{, }\DecValTok{195}\NormalTok{, }\AttributeTok{type =} \DecValTok{1}\NormalTok{)}
\FunctionTok{grid.text}\NormalTok{(}\AttributeTok{x=}\FunctionTok{unit}\NormalTok{(}\DecValTok{280}\NormalTok{,}\StringTok{\textquotesingle{}native\textquotesingle{}}\NormalTok{), }\AttributeTok{y=}\FunctionTok{unit}\NormalTok{(}\DecValTok{220}\NormalTok{,}\StringTok{\textquotesingle{}native\textquotesingle{}}\NormalTok{),}
  \AttributeTok{label=}\FunctionTok{expression}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{\textquotesingle{}Sept{-}2010\textquotesingle{}}\NormalTok{),}\AttributeTok{just =} \StringTok{"centre"}\NormalTok{,}\StringTok{\textquotesingle{}type=4\textquotesingle{}}\NormalTok{))}
\FunctionTok{grid.brackets}\NormalTok{(}\DecValTok{480}\NormalTok{, }\DecValTok{195}\NormalTok{, }\DecValTok{360}\NormalTok{, }\DecValTok{195}\NormalTok{, }\AttributeTok{type =} \DecValTok{1}\NormalTok{)}
\FunctionTok{grid.text}\NormalTok{(}\AttributeTok{x=}\FunctionTok{unit}\NormalTok{(}\DecValTok{430}\NormalTok{,}\StringTok{\textquotesingle{}native\textquotesingle{}}\NormalTok{), }\AttributeTok{y=}\FunctionTok{unit}\NormalTok{(}\DecValTok{220}\NormalTok{,}\StringTok{\textquotesingle{}native\textquotesingle{}}\NormalTok{),}
  \AttributeTok{label=}\FunctionTok{expression}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{\textquotesingle{}Dec{-}2010\textquotesingle{}}\NormalTok{),}\AttributeTok{just =} \StringTok{"centre"}\NormalTok{,}\StringTok{\textquotesingle{}type=4\textquotesingle{}}\NormalTok{))}
\FunctionTok{grid.text}\NormalTok{(}\AttributeTok{x=}\FunctionTok{unit}\NormalTok{(}\DecValTok{280}\NormalTok{,}\StringTok{\textquotesingle{}native\textquotesingle{}}\NormalTok{), }\AttributeTok{y=}\FunctionTok{unit}\NormalTok{(}\DecValTok{250}\NormalTok{,}\StringTok{\textquotesingle{}native\textquotesingle{}}\NormalTok{),}
  \AttributeTok{label=}\FunctionTok{expression}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{\textquotesingle{}Placebo treatment time\textquotesingle{}}\NormalTok{),}\AttributeTok{just =} \StringTok{"centre"}\NormalTok{,}\StringTok{\textquotesingle{}type=4\textquotesingle{}}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
