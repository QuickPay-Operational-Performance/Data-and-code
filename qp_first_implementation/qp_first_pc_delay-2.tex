...
\hypertarget{continuous-version-full-sample}{%
\subsubsection{Continuous version: Full
Sample}\label{continuous-version-full-sample}}
...
\hline \\[-1.8ex] 
 ...
 $Post_t$ & 1.08$^{***}$ & $-$8.01$^{***}$ &  &  &  \\ 
  & (0.13) & (0.80) &  &  &  \\ 
  & & & & & \\ 
 Num Contractor Projects & 0.01$^{***}$ & 0.004$^{***}$ & 0.004$^{***}$ & 0.01$^{***}$ & 0.01$^{***}$ \\ 
  & (0.001) & (0.0004) & (0.0004) & (0.0004) & (0.0004) \\ 
  & & & & & \\ 
 $Treat_i \times Post_t$ & $-$0.001 & 1.20$^{***}$ & 1.20$^{***}$ & 0.82$^{***}$ & 0.84$^{***}$ \\ 
  & (0.16) & (0.15) & (0.15) & (0.15) & (0.15) \\ 
  & & & & & \\ 
 $Post_t \times$ Num Contractor Projects & $-$0.01$^{***}$ & $-$0.002$^{***}$ & $-$0.002$^{***}$ & $-$0.005$^{***}$ & $-$0.005$^{***}$ \\ 
  & (0.001) & (0.0004) & (0.0004) & (0.0004) & (0.0004) \\ 
  & & & & & \\ 
 $Treat_i \times$ Num Contractor Projects & $-$0.02$^{***}$ & $-$0.01$^{***}$ & $-$0.01$^{***}$ & $-$0.01$^{***}$ & $-$0.01$^{***}$ \\ 
  & (0.001) & (0.001) & (0.001) & (0.001) & (0.001) \\ 
  & & & & & \\ 
 $Treat_i \times Post_t \times$ Num Contractor Projects & 0.01$^{***}$ & 0.0002 & 0.0005 & 0.003$^{***}$ & 0.003$^{***}$ \\ 
  & (0.001) & (0.001) & (0.001) & (0.001) & (0.001) \\ 
  & & & & & \\ 
 Constant & 4.68$^{***}$ & 52.97$^{***}$ &  &  &  \\ 
  & (0.11) & (0.61) &  &  &  \\ 
...
\hypertarget{discrete-version-full-sample}{%
\subsection{Discrete version: Full
Sample}\label{discrete-version-full-sample}}

\includegraphics{qp_first_pc_delay-2_files/figure-latex/num_projs_discrete-1.pdf}

\hypertarget{restricted-sample-contractors-active-before-quickpay}{%
\subsection{Restricted Sample: Contractors active before
QuickPay}\label{restricted-sample-contractors-active-before-quickpay}}

\includegraphics{qp_first_pc_delay-2_files/figure-latex/num_projects_1-1.pdf}

\hypertarget{continuous-version-restricted-sample}{%
\subsubsection{Continuous version: Restricted
Sample}\label{continuous-version-restricted-sample}}

\begin{table}[H] \centering 
  \caption{Num Contractor Projects and QuickPay reform: Restricted Sample} 
  \label{} 
\small 
\begin{tabular}{@{\extracolsep{-2pt}}lccccc} 
\\[-1.8ex]\hline 
...
\\[-1.8ex] & (1) & (2) & (3) & (4) & (5)\\ 
\hline \\[-1.8ex] 
 $Treat_i$ & $-$0.24$^{*}$ & $-$0.95$^{***}$ & $-$0.96$^{***}$ & $-$0.58$^{***}$ & $-$0.56$^{***}$ \\ 
  & (0.14) & (0.12) & (0.12) & (0.12) & (0.12) \\ 
  & & & & & \\ 
 $Post_t$ & 1.06$^{***}$ & $-$8.72$^{***}$ &  &  &  \\ 
  & (0.13) & (0.81) &  &  &  \\ 
 ...
 Num Contractor Projects & 0.01$^{***}$ & 0.004$^{***}$ & 0.004$^{***}$ & 0.01$^{***}$ & 0.01$^{***}$ \\ 
  & (0.001) & (0.0004) & (0.0004) & (0.0004) & (0.0004) \\ 
  & & & & & \\ 
 $Treat_i \times Post_t$ & $-$0.05 & 1.16$^{***}$ & 1.16$^{***}$ & 0.83$^{***}$ & 0.87$^{***}$ \\ 
 ...
 $Treat_i \times$ Num Contractor Projects & $-$0.02$^{***}$ & $-$0.01$^{***}$ & $-$0.01$^{***}$ & $-$0.01$^{***}$ & $-$0.01$^{***}$ \\ 
  & (0.001) & (0.001) & (0.001) & (0.001) & (0.001) \\ 
  & & & & & \\ 
 $Treat_i \times Post_t \times$ Num Contractor Projects & 0.01$^{***}$ & 0.001 & 0.001 & 0.003$^{***}$ & 0.003$^{***}$ \\ 
  & (0.001) & (0.001) & (0.001) & (0.001) & (0.001) \\ 
  & & & & & \\ 
 Constant & 4.68$^{***}$ & 52.97$^{***}$ &  &  &  \\ 
  & (0.11) & (0.61) &  &  &  \\ 
...
Task fixed effects & No & No & No & Yes & Yes \\ 
Industry fixed effects & No & No & No & No & Yes \\ 
Observations & 252,031 & 228,843 & 228,843 & 228,843 & 228,843 \\ 
R$^{2}$ & 0.01 & 0.22 & 0.22 & 0.25 & 0.26 \\ 
Adjusted R$^{2}$ & 0.01 & 0.22 & 0.22 & 0.25 & 0.25 \\ 
\hline 
\hline \\[-1.8ex] 
...
\hypertarget{discrete-version-restricted-sample}{%
\subsubsection{Discrete version: Restricted
Sample}\label{discrete-version-restricted-sample}}

\includegraphics{qp_first_pc_delay-2_files/figure-latex/num_projs_discrete_restricted-1.pdf}
