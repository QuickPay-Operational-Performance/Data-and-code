...
reg_df[,indirect_treat:=case_when(treat_i==0 & num_small_projects>0 ~ 1,
                                  treat_i==0 & num_small_projects==0 ~ 0,
                                  treat_i==1 ~ NaN)]

m1=felm(wins_percentage_delay~indirect_treat+
                            post_t:indirect_treat+
                            log(1+num_small_projects)+
                            post_t:log(1+num_small_projects)+
                            post_t|
                            0|
                            0|
                            contract_award_unique_key,
...
m2=felm(wins_percentage_delay~indirect_treat+
                            post_t:indirect_treat+
                            log(1+num_small_projects)+
                           log(wins_project_quarter_stage)+
                            post_t:log(1+num_small_projects)+
...
m3=felm(wins_percentage_delay~indirect_treat+
                            post_t:indirect_treat+
                            log(1+num_small_projects)+
                           log(wins_project_quarter_stage)+
                            post_t:log(1+num_small_projects)+
...
m4=felm(wins_percentage_delay~indirect_treat+
                            post_t:indirect_treat+
                            log(1+num_small_projects)+
                           log(wins_project_quarter_stage)+
                            post_t:log(1+num_small_projects)+
...
m5=felm(wins_percentage_delay~indirect_treat+
                            post_t:indirect_treat+
                            log(1+num_small_projects)+
                           log(wins_project_quarter_stage)+
                            post_t:log(1+num_small_projects)+
...
portfolio_large_projs_did=stargazer(m1,m2,m3,m4,m5,
          ...
          dep.var.labels="$PercentDelay_{it}$",
          dep.var.caption = "",
          covariate.labels =c("Indirect Treat",
                              "Num of small projects (logged)",
                               "$Post_t$",
                               "Indirect Treat $\\times Post_t$",
                               "Num of small projects (logged) $\\times Post_t$",
                               "Constant"),
          object.names=FALSE, 
          model.numbers=TRUE,
          font.size = "small",
...
* TreatIntensity_i = log(1+ number of large projects held by contractor of small project i). [Group 1]
* TreatIntensity_i = 0 if project i is a small project but with no large project. [Group 2]
* TreatIntensity_i = 0 if project i is a large project. [Group 3]

```{r ti_1, warning=FALSE, echo=FALSE, results='asis'}
# treat_small_with_large_new = 1 ==> treat_new = 1
reg_df_subset[,treat_small_with_large_intensity:=treat_small_with_large_new*log(1+num_large_projects)]
m1=felm(wins_percentage_delay~treat_new+
          treat_small_with_large_intensity+
          treat_new:post_t+
          post_t:treat_small_with_large_intensity+
          post_t|
          0|
          0|
          contract_award_unique_key,
...
* Treat_i = 1 for remaining small projects.
* Treat_Intensity_Small_i = log(1 + number of small projects) for treated project i
   * Equivalently, Treat_Intensity_Small_i = Treat_i x log(1 + number of small projects)
* Treat_Intensity_Small_i = 0 for large project i
* Treat_Intensity_Large_i = log(1 + number of large projects) for treated project i
* Treat_Intensity_Large_i = 0 for large project i
...
both_small_and_large_contractors=intersect(large_contractors,
                                           small_contractors)
...
m1=felm(wins_percentage_delay~treat_new+
                            ...
                            0|
                            contract_award_unique_key,
                          data=subset(reg_df, !(recipient_duns%in%both_small_and_large_contractors)),
                          exactDOF = TRUE, 
                          cmethod = "reghdfe")
