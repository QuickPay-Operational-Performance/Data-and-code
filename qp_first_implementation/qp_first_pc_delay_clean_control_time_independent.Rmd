...
```{r project_portfolio_setup, include=FALSE}
...
```{r project_portfolio, warning=FALSE, include=FALSE, eval=FALSE, results='asis'}
...
```{r treatment_intensity_1, warning=FALSE, include=FALSE, eval=FALSE}
## Treatment intensity 1 (Percentage of small projects)

reg_df[,pc_small_projects:=100*num_small_projects/(num_small_projects+num_large_projects)]
                                         

m1=felm(wins_percentage_delay~pc_small_projects+
                            post_t:pc_small_projects+
                            post_t|
                            0|
                            0|
                            contract_award_unique_key,
                          data=subset(reg_df, treat_i==0),
                          exactDOF = TRUE, 
                          cmethod = "reghdfe")

m2=felm(wins_percentage_delay~pc_small_projects+
                           log(wins_project_quarter_stage)+
                            post_t:pc_small_projects+
                            log(1+winsorized_initial_duration_in_days_i)+
                            log(1+winsorized_initial_budget_i)+
...
m3=felm(wins_percentage_delay~pc_small_projects+
                           log(wins_project_quarter_stage)+
                            post_t:pc_small_projects+
                            log(1+winsorized_initial_duration_in_days_i)+
                            log(1+winsorized_initial_budget_i)+
...
m4=felm(wins_percentage_delay~pc_small_projects+
                           log(wins_project_quarter_stage)+
                            post_t:pc_small_projects+
                            log(1+winsorized_initial_duration_in_days_i)+
                            log(1+winsorized_initial_budget_i)+
...
m5=felm(wins_percentage_delay~pc_small_projects+
                           log(wins_project_quarter_stage)+
                            post_t:pc_small_projects+
                            log(1+winsorized_initial_duration_in_days_i)+
                            log(1+winsorized_initial_budget_i)+
...
portfolio_large_projs_did=stargazer(m1,m2,m3,m4,m5,
          ...
          dep.var.labels="$PercentDelay_{it}$",
          dep.var.caption = "",
          covariate.labels =c("Percentage of small projects",
                               "$Post_t$",
                               "Percentage of small projects $\\times Post_t$",
                               "Constant"),
          object.names=FALSE, 
          model.numbers=TRUE,
          font.size = "small",
...
```{r treatment_intensity_2, warning=FALSE, echo=FALSE, results='asis'}

reg_df[,indirect_treat_intensity:=indirect_treat_i*log(1+num_small_projects)]

m1=felm(wins_percentage_delay~indirect_treat_intensity+
                            post_t:indirect_treat_intensity+
                            post_t|
                            0|
                            0|
                            contract_award_unique_key,
...
m2=felm(wins_percentage_delay~indirect_treat_intensity+
                           log(wins_project_quarter_stage)+
                            post_t:indirect_treat_intensity+
                            log(1+winsorized_initial_duration_in_days_i)+
                            log(1+winsorized_initial_budget_i)+
...
m3=felm(wins_percentage_delay~indirect_treat_intensity+
                           log(wins_project_quarter_stage)+
                            post_t:indirect_treat_intensity+
                            log(1+winsorized_initial_duration_in_days_i)+
                            log(1+winsorized_initial_budget_i)+
...
m4=felm(wins_percentage_delay~indirect_treat_intensity+
                           log(wins_project_quarter_stage)+
                            post_t:indirect_treat_intensity+
                            log(1+winsorized_initial_duration_in_days_i)+
                            log(1+winsorized_initial_budget_i)+
...
m5=felm(wins_percentage_delay~indirect_treat_intensity+
                           log(wins_project_quarter_stage)+
                            post_t:indirect_treat_intensity+
                            log(1+winsorized_initial_duration_in_days_i)+
                            log(1+winsorized_initial_budget_i)+
...
portfolio_large_projs_did=stargazer(m1,m2,m3,m4,m5,
          ...
          dep.var.labels="$PercentDelay_{it}$",
          dep.var.caption = "",
          covariate.labels =c("Indirect Treat Intensity",
                               "$Post_t$",
                               "Indirect Treat Intensity $\\times Post_t$",
                               "Constant"),
          object.names=FALSE, 
          model.numbers=TRUE,
          font.size = "small",
...
## DID on small projects

```{r project_portfolio_spillover_2, include=FALSE, eval=FALSE}
...
* Remove projects in Group 2 (with only small projects).
* Treat_Intensity_Small_i = Treat_i x log(1 + number of small projects)
* Treat_Intensity_Large_i = Treat_i x log(1 + number of large projects)

```{r ti_2, warning=FALSE, echo=FALSE, results='asis'}
...
reg_df_subset[,treat_intensity_small:=treat_new*log(1+num_small_projects)]
reg_df_subset[,treat_intensity_large:=treat_new*log(1+num_large_projects)]

m1=felm(wins_percentage_delay~treat_intensity_small+
          treat_intensity_large+
          post_t:treat_intensity_small+
          post_t:treat_intensity_large+
          post_t|
          0|
          0|
          contract_award_unique_key,
          data=subset(reg_df_subset,!(treat_i==1 & !(recipient_duns%in%large_contractors))),
        exactDOF = TRUE,
        cmethod = "reghdfe")

m2=felm(wins_percentage_delay~treat_intensity_small+
          treat_intensity_large+
          post_t:treat_intensity_small+
          post_t:treat_intensity_large+
          log(wins_project_quarter_stage)+
...
m3=felm(wins_percentage_delay~treat_intensity_small+
          treat_intensity_large+
          post_t:treat_intensity_small+
          post_t:treat_intensity_large+
          log(wins_project_quarter_stage)+
...
m4=felm(wins_percentage_delay~treat_intensity_small+
          treat_intensity_large+
          post_t:treat_intensity_small+
          post_t:treat_intensity_large+
          log(wins_project_quarter_stage)+
...
m5=felm(wins_percentage_delay~treat_intensity_small+
          treat_intensity_large+
          post_t:treat_intensity_small+
          post_t:treat_intensity_large+
          log(wins_project_quarter_stage)+
...
portfolio_did=stargazer(m1,m2,m3,m4,m5,
          ...
          dep.var.labels="$PercentDelay_{it}$  ",
          dep.var.caption = "",
          covariate.labels =c("$TreatIntensity_i$ (Small)",
                              "$TreatIntensity_i$ (Large)",
                              "$Post_t$",
                              "$TreatIntensity_i$ (Small) $\\times Post_t$",
...
* Treat_Intensity_Small = Treat_i x log(1 + number of small projects)
* Restricted to only projects in Groups 2 and 3, i.e., only small and only large.
* Group 1 small projects are excluded.

```{r ti_3, warning=FALSE, echo=FALSE, results='asis'}
...
m1=felm(wins_percentage_delay~treat_intensity_small+
                            ...
                            0|
                            contract_award_unique_key,
                          data=subset(reg_df_subset,!(treat_i==1 & num_large_projects>0)),
                          exactDOF = TRUE, 
                          cmethod = "reghdfe")
...
portfolio_large_projs_did=stargazer(m1,m2,m3,m4,m5,
          ...
          dep.var.labels="$PercentDelay_{it}$",
          dep.var.caption = "",
          covariate.labels =c("Treat Intensity (Small)",
                               "$Post_t$",
                               "Treat Intensity (Small) $\\times Post_t$",
                               "Constant"),
          object.names=FALSE, 
          model.numbers=TRUE,
          font.size = "small",
          ...
          style="default",
           notes=c("Each observation is a project-quarter.",
                   "SEs are robust and clustered at the project level.",
                   "Contractors holding both small and large projects are excluded."),
          #         "Treat is an indicator that equals one for LARGE projects that have at least one parallel small project in the same quarter, and is zero otherwise."),
          header=F)
```
