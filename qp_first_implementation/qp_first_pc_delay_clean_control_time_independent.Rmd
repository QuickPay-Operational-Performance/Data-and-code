...
* That is, fraction of projects on which contractor receives financing is greater than the median of those receiving financing on projects.

```{r cf_contractor_level_median, results='asis',echo=FALSE}

num_projects_contractor=reg_df_subset[,n_distinct(contract_award_unique_key),by='recipient_duns']
...
contract_financing_contractor[,pc_projects_receiving_cf:=num_projects_receiving_financing/num_projects_contractor]
