...
* For contractor k, define Treat_Intensity_k = (Budget of all small projects before QP)/(Budget of all projects before QP)
...
reg_df_subset[,treat_intensity_budget_i:=budget_small_projects/(budget_small_projects+budget_large_projects)]
