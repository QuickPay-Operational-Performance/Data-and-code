...
* TreatIntensity_i = Treat x log(1+ number of large projects)

```{r ti_1, warning=FALSE, echo=FALSE, results='asis'}
# treat_small_with_large_new = 1 ==> treat_new = 1
reg_df_subset[,treat_intensity:=treat_new*log(1+num_large_projects)]
...
portfolio_did=stargazer(m1,m2,m3,m4,m5,
          ...
          dep.var.labels="$PercentDelay_{it}$  ",
          dep.var.caption = "",
          covariate.labels =c("$TreatIntensity_i$",
                               "$Post_t$",
                               "$TreatIntensity_i \\times Post_t$",
                               "Constant"),
          object.names=FALSE, 
          model.numbers=TRUE,
          font.size = "small",
