...
m1=felm(wins_percentage_delay~log(1+num_small_projects)+
...
m2=felm(wins_percentage_delay~log(1+num_small_projects)+
                           log(wins_project_quarter_stage)+
                            post_t:log(1+num_small_projects)+
                            log(1+winsorized_initial_duration_in_days_i)+
                            log(1+winsorized_initial_budget_i)+
...
m3=felm(wins_percentage_delay~log(1+num_small_projects)+
                           log(wins_project_quarter_stage)+
                            post_t:log(1+num_small_projects)+
                            log(1+winsorized_initial_duration_in_days_i)+
                            log(1+winsorized_initial_budget_i)+
...
m4=felm(wins_percentage_delay~log(1+num_small_projects)+
                           log(wins_project_quarter_stage)+
                            post_t:log(1+num_small_projects)+
                            log(1+winsorized_initial_duration_in_days_i)+
                            log(1+winsorized_initial_budget_i)+
...
m5=felm(wins_percentage_delay~log(1+num_small_projects)+
                           log(wins_project_quarter_stage)+
                            post_t:log(1+num_small_projects)+
                            log(1+winsorized_initial_duration_in_days_i)+
                            log(1+winsorized_initial_budget_i)+
...
portfolio_large_projs_did=stargazer(m1,m2,m3,m4,m5,
          ...
          dep.var.labels="$PercentDelay_{it}$",
          dep.var.caption = "",
          covariate.labels =c("Num of small projects (logged)",
                               "$Post_t$",
