...
* TreatIntensity_i = log(1+ number of large projects held by contractor of small project i).
* TreatIntensity_i = 0 if project i is a small project but with no large project.
* TreatIntensity_i = 0 if project i is a large project.

```{r project_portfolio_spillover_2_ti, warning=FALSE, echo=FALSE, results='asis'}
# treat_small_with_large_new = 1 ==> treat_new = 1
