...
# Including it as fixed effects doesn't work because projects in treatment and control are not always in same "tercile" while controlling for everything else. 
```
...
ggplot(mean_delay, aes(x=year_quarter,
    ...
    annotate("text", label = "QuickPay\n implemented", x = 8, y = 500,color="dimgrey")+
    geom_vline(xintercept = 10.2, linetype="solid", 
                color = "gray", size=1.5)+
    scale_shape_discrete(name  ="Business Size",
                          breaks=c("O", "S"),
