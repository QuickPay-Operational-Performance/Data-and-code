...
df_first_reported=subset(df_first_reported,
                         as.Date(action_date)<as.Date('2012-07-01')&
             contract_award_unique_key%in%projects_to_keep$contract_award_unique_key)
```
...
# 
# 
# reg_df[,stage_at_time_of_qp:=ifelse(action_date_year_quarter=="2011-03-31",
#                                     project_quarter_stage,
#                                     NaN)]
# projects_at_time_of_qp=subset(reg_df,!is.na(stage_at_time_of_qp))[,c('contract_award_unique_key',
#                                                                      'stage_at_time_of_qp')]
# 
# reg_df=reg_df[,-c('stage_at_time_of_qp')]
# 
# reg_df=merge(reg_df,
#              projects_at_time_of_qp,
#              by='contract_award_unique_key',
#              all.x=T)
# 
# reg_df[,wins_stage_at_qp:=Winsorize(stage_at_time_of_qp,                    
#                               probs=c(0.025,0.975),
#                               na.rm=T)]
```
...
fixest::iplot(mod_twfe, 
      ...
      main = 'Effect on Percentage Delay Rate',
      grid=F,
      ylim.add=0.15,
